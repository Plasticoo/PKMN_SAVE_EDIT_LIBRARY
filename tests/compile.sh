...
scan-build gcc -std=gnu11 -Wall -Wextra -ggdb -I../include unit_tests.c unity/unity.c ../lib/utils.c ../lib/gen1/gen1_funcs.c ../lib/gen1/gen1_math.c ../lib/gen1/gen1_structs.c -o unit_tests -lm -DDEBUG
