...
void gen1_load_file(struct gen1_pkmn_file_struct* file_struct)
{
    ...
    for (i = 0; i < POKEMON_PARTY_SIZE; i++) {
        ...
        file_struct->team_pokemon_list[i]->hp          = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + CURRENT_HP_OFFSET];
        ...
        file_struct->team_pokemon_list[i]->trainer_id  = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + TRAINER_ID_OFFSET];
        file_struct->team_pokemon_list[i]->xp[0]       = &file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + XP_POINTS_OFFSET];
        file_struct->team_pokemon_list[i]->xp[1]       = &file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + XP_POINTS_OFFSET];
        file_struct->team_pokemon_list[i]->xp[2]       = &file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + XP_POINTS_OFFSET];
        file_struct->team_pokemon_list[i]->hp_ev       = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + HP_EV_OFFSET];
        file_struct->team_pokemon_list[i]->atk_ev      = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + ATTACK_EV_OFFSET];
        file_struct->team_pokemon_list[i]->def_ev      = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + DEFENSE_EV_OFFSET];
        file_struct->team_pokemon_list[i]->speed_ev    = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + SPEED_EV_OFFSET];
        file_struct->team_pokemon_list[i]->special_ev  = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + SPECIAL_EV_OFFSET];
        file_struct->team_pokemon_list[i]->iv          = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + IV_OFFSET];
        ...
        file_struct->team_pokemon_list[i]->max_hp      = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + MAX_HP_OFFSET];
        file_struct->team_pokemon_list[i]->atk         = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + ATTACK_OFFSET];
        file_struct->team_pokemon_list[i]->def         = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + DEFENSE_OFFSET];
        file_struct->team_pokemon_list[i]->speed       = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + SPEED_OFFSET];
        file_struct->team_pokemon_list[i]->special     = (u16*)&file_struct->file_map[pokemon_list_offset + pokemon_list_data_offset + SPECIAL_OFFSET];
